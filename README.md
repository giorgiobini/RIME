...
## 1. Environment setup
We recommend building a Python virtual environment with Anaconda.
RIME was developed on a machine with CUDA version **525**, toolkit CUDA version **CUDA 12.0**, and **cuDNN version 8.8.1.3**.

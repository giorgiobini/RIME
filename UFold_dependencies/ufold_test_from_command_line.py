...
def main():
    ...
    MODEL_SAVED = '/data01/gbini/projects/DETR/UFold_dependencies/models/ufold_train_alldata.pt'

    d = config.u_net_d
    BATCH_SIZE = 10
    print(config.batch_size_stage_1)
    ...
    if test_file == 'RNAStralign' or test_file == 'ArchiveII':
        test_data = RNASSDataGenerator('/data01/gbini/projects/DETR/UFold_dependencies/data/', test_file+'.pickle')
    else:
        test_data = RNASSDataGenerator('/data01/gbini/projects/DETR/UFold_dependencies/data/',test_file+'.cPickle')

...
def main():
    ...
    for file_item in train_files:
        ...
        if file_item == 'RNAStralign' or file_item == 'ArchiveII':
            train_data_list.append(RNASSDataGenerator('/data01/gbini/projects/DETR/UFold_dependencies/data/', file_item+'.pickle')) 
        else:
            train_data_list.append(RNASSDataGenerator('/data01/gbini/projects/DETR/UFold_dependencies/data/', file_item+'.cPickle'))
